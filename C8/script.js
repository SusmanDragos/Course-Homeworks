...
const showInfo = () => {
  document.getElementById("picture").src = myImages[counter].link;
  document.getElementById("name").innerHTML = myImages[counter].name;
  document.getElementById("description").innerHTML =
    myImages[counter].description;
};
...
const download = () => {
  window.open(myImages[counter].link);
};
